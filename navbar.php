...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSq0C-va0fsrwxKwc0plqhtdaJCej4GR2wi3SO0LyfodpJqUfJavisOOh5foyJ0knYTrfA&usqp=CAU" style="width: 30px;"> &nbsp
</a>
  ...
  <div class="collapse navbar-collapse" id="basicExampleNav">
    ...
    <li class="nav-item">
    <a class="nav-link" id="aboutbtn"> User: <?php echo $_SESSION['username'] ?> </a>
    </li>
    </ul>
