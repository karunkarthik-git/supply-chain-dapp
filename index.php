...
<html lang="en">
  ...
  <div style="width: 100%;" >
    <center>
      <div class="loginformcard" id="card1" style="margin-top:100px;">
        <div class="row">
          <div class="col">
            <img width="300px" height="300px" src="https://image.shutterstock.com/image-vector/light-bar-graph-600w-367371239.jpg"/>
          </div>
          <div class="col">
            <p style="max-width: 80%;">
              <center><h4>The Supply Chain DAPP</h4></center>
              <br/>
              <br/>
